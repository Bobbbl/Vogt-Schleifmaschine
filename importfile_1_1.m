function [Nummerierung,Zeit,Amplitude] = importfile_1_1(filename, startRow, endRow)
%IMPORTFILE1 Import numeric data from a text file as column vectors.
%   [NUMMERIERUNG,ZEIT,AMPLITUDE] = IMPORTFILE1(FILENAME) Reads data from
%   text file FILENAME for the default selection.
%
%   [NUMMERIERUNG,ZEIT,AMPLITUDE] = IMPORTFILE1(FILENAME, STARTROW, ENDROW)
%   Reads data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   [Nummerierung,Zeit,Amplitude] = importfile1('2016-02-24-WinterD15B-Versuch6.txt',1, 19213);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2016/02/24 15:10:40
...
Nummerierung = cell2mat(rawNumericColumns(:, 1));
Zeit = dates{:, 1};
Amplitude = cell2mat(rawNumericColumns(:, 2));
